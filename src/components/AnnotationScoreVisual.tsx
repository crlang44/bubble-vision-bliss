...
const AnnotationScoreVisual: React.FC<AnnotationScoreVisualProps> = ({ className = '' }) => {
  return (
    <div className={`bg-white p-4 rounded-lg shadow-md mx-auto text-center ${className}`}>
      <h3 className="text-lg font-medium text-ocean-dark mb-3 flex items-center justify-center gap-2">
        <Target className="h-5 w-5 text-ocean-medium" />
        Annotation Precision Guide
      </h3>
      
      <div className="grid grid-cols-2 gap-4 mx-auto max-w-lg">
          ...
          <HoverCardTrigger asChild>
            <div className="relative cursor-help border-2 border-dashed border-red-400 rounded-md p-4 bg-gray-50">
              ...
              <div className="text-center mt-8">
                <p className="text-sm font-medium text-red-500">Loose Annotation</p>
                <p className="text-xl font-bold text-red-500">60% Score</p>
              </div>
            </div>
          </HoverCardTrigger>
        ...
        <HoverCard>
          <HoverCardTrigger asChild>
            <div className="relative cursor-help border-2 border-dashed border-green-500 rounded-md p-4 bg-gray-50">
              ...
              <div className="text-center mt-8">
                <p className="text-sm font-medium text-green-500">Tight Annotation</p>
                <p className="text-xl font-bold text-green-500">95% Score</p>
              </div>
            </div>
          </HoverCardTrigger>
          <HoverCardContent className="w-80">
      ...
      <div className="mt-4 bg-blue-50 p-3 rounded-md border border-blue-100 text-sm text-blue-700">
        <p className="flex items-center justify-center gap-1">
          <Square className="h-4 w-7 text-ocean-medium" />
