...
const NavBar: React.FC<NavBarProps> = ({ 
  ...
  return (
    <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-1 bg-transparent pt-2 rounded-lg z-50 relative min-h-0 gap-2 sm:gap-0">
      ...
      <div className="flex flex-wrap gap-2 items-center w-full sm:w-auto justify-end">
        ...
        {bestScore > 0 && (
          <Button
            variant="outline"
            className="bg-white/80 hover:bg-white text-ocean-dark px-3 h-9 text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200 border border-ocean-dark/20 hover:border-ocean-dark/40 flex items-center gap-1.5"
          >
            <Trophy className="h-4 w-4 text-yellow-600 flex-shrink-0" />
            <span className="whitespace-nowrap">Best: {bestScore}</span>
          </Button>
        )}
        ...
        <Button
          ...
          className="bg-white/80 hover:bg-white text-ocean-dark px-3 h-9 text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200 border border-ocean-dark/20 hover:border-ocean-dark/40"
        >
